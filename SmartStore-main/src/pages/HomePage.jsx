...
import dashboardImage from "../assets/foundation-dashboard.png";
import growthImage from "../assets/foundation-growth.png";
import fulfillmentImage from "../assets/foundation-fulfillment.png";
import mobileImage from "../assets/foundation-mobile.png";
        ...
        <div className="guest-hero-media">
          <div className="hero-image-shell">
            <video
              ...
              aria-label={isArabic ? "فيديو SmartStore" : "SmartStore video"}
            />
          </div>
        </div>
        ...
        <div className="guest-foundation-grid">
          <article className="foundation-card">
            <div className="foundation-visual">
              <img src={dashboardImage} alt="Dashboard" className="foundation-image" />
            </div>
          ...
          <article className="foundation-card">
            <div className="foundation-visual">
              <img src={growthImage} alt="Growth" className="foundation-image" />
            </div>
          ...
          <article className="foundation-card">
            <div className="foundation-visual">
              <img src={fulfillmentImage} alt="Fulfillment" className="foundation-image" />
            </div>
          ...
          <article className="foundation-card">
            <div className="foundation-visual">
              <img src={mobileImage} alt="Mobile" className="foundation-image" />
            </div>
